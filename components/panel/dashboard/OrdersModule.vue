...
<template>
    <section class="flex flex-col gap-4 w-full p-4 md:p-6 bg-bgAccent rounded-3xl">
        <header class="flex items-center gap-2 w-full">
            <h3 class="font-extrabold text-fgPrimary">{{ $t("panel.dashboard.Orders Statistics") }}</h3>
