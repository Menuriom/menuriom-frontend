    ...
    <Wrapper class="flex flex-col gap-4 w-full p-4 bg-bgAccent rounded-2xl shadow-mr15" :defaultState="0">
        ...
        <div class="flex flex-col gap-6 overflow-hidden">
            <div class="flex flex-wrap items-center gap-2">
                <h5 class="text-sm opacity-80">{{ $t("panel.menu-style.Items Style") }}</h5>
                <ul class="flex flex-wrap items-center gap-2">
                    <li
                        class="flex items-center gap-2 p-1.5 rounded-full border border-bgSecondary shadow-nr15 cursor-pointer"
                        :class="{ 'bg-bgSecondary': itemListOptions.component == item }"
            ...
            <div class="flex flex-wrap items-center gap-2" v-if="itemListOptions.component === 'ItemList3'">
                <h5 class="text-sm opacity-80">{{ $t("panel.menu-style.Show items in zig-zag") }}</h5>
            ...
            <div class="flex flex-wrap lg:flex-nowrap gap-4 w-full">
                <div class="flex flex-col gap-4 p-4 w-full rounded-2xl bg-bgSecondary bg-opacity-30">
                    ...
                    <div class="flex flex-col gap-4" v-if="itemListOptions.withPattern">
                        <div
...
const selectPatternImage = () => {
    ...
    props.itemListOptions.bgImageFile = image.value.files[0];
    props.itemListOptions.bgImage = URL.createObjectURL(image.value.files[0]);
    props.itemListOptions.bgImageMode = selectedPatternMode.value = "upload";
};
const selectPatternFromList = (pattern) => {
    props.itemListOptions.bgImage = pattern;
    props.itemListOptions.bgImageMode = selectedPatternMode.value = "list";
};
</script>
