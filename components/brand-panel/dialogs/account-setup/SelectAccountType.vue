            ...
            <ul class="flex flex-col gap-3 w-full">
                <div class="cursor-pointer rounded-xl hover:bg-baby-blue p-1">
                    <li class="flex gap-3 w-full p-3 rounded-lg bg-white text-pencil-tip" @click="selectOption('store-owner')">
                        ...
                        <div class="flex flex-col gap-1 flex-grow">
                            <h4 class="font-bold whitespace-nowrap text-ellipsis">{{ $t("brand-panel.account-setup.For my store or restaurant") }}</h4>
                            <p class="text-xs">
                                {{ $t("brand-panel.account-setup.This is for users who want to create and manage their restaurant menus and orders") }}
                            </p>
                        </div>
                    </li>
                </div>
                <div class="cursor-pointer rounded-xl hover:bg-baby-blue p-1">
                    <li class="flex gap-3 w-full p-3 rounded-lg bg-white text-pencil-tip" @click="selectOption('staff-member')">
                        ...
                        <div class="flex flex-col gap-1 flex-grow">
                            <h4 class="font-bold whitespace-nowrap text-ellipsis">{{ $t("brand-panel.account-setup.Im part of a staff or team") }}</h4>
                            <p class="text-xs">
                                {{ $t("brand-panel.account-setup.This is for users who are part of a restaurant and want to join as a staff member") }}
                            </p>
                        </div>
                    </li>
                </div>
