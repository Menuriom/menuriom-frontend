...
<template>
    <section class="flex flex-col items-center gap-10 w-full p-8">
        <div class="flex flex-col items-center gap-2">
            ...
            <h4 class="text-2xl opacity-60 font-extralight text-center">Start creating instantly. Start free.</h4>
        </div>
        <div class="relative flex items-center gap-10 p-3 px-5 rounded-md bg-neutral-200">
            ...
            <b class="relative cursor-pointer" @click="togglePriceType('monthly')">Monthly</b>
        ...
        <ul class="flex flex-wrap justify-center gap-12 w-full max-w-screen-xl mt-12">
            <li
                class="flex flex-col gap-3 rounded-2xl shadow-xl"
