    ...
    <div class="relative flex justify-center items-end w-full max-w-screen-4xl px-2 md:px-6 md:-mt-2">
        ...
        >
            ...
            <div class="relative flex flex-col items-center 1.5xl:items-start gap-6 md:gap-10 w-full max-w-6xl bg-neutral-5000 isolate">
                ...
                <h1 class="flex flex-col items-center 1.5xl:items-start text-4xl/snug sm:text-5xl/snug md:text-7xl/snug font-extrabold">
                ...
                <div class="relative flex flex-col gap-6 w-full max-w-5xl bg-bgPrimary bg-opacity-70 text-fgPrimary rounded-2xl p-6 sm:p-8 shadow-mr15 isolate">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3 sm:gap-5 sm:mt-4">
                        ...
                        <nuxt-link class="p-4 px-8 hover:px-12 rounded-xl bg-primary text-fgPrimary transition-all shadow-mr25" to="/panel" v-else>
                            <span class="f-inter md:text-xl font-bold">{{ $t("home.Head To Dashboard") }}</span>
                        </nuxt-link>
                        <span class="hidden sm:inline-block">{{ $t("auth.OR") }}</span>
                        <nuxt-link
                            class="p-4 px-8 hover:px-12 rounded-xl bg-fgPrimary text-bgPrimary transition-all shadow-mr25"
                            to="/demo"
                            v-if="!user.email.value"
                        >
                            <span class="f-inter md:text-xl font-bold">{{ $t("home.Check The Demo") }}</span>
                        </nuxt-link>
                        <nuxt-link class="p-4 px-8 hover:px-12 rounded-xl bg-fgPrimary text-bgPrimary transition-all shadow-mr25" to="/help-center" v-else>
