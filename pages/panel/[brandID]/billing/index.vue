        ...
        <section class="flex flex-col gap-4 w-full" name="Billing Info">
            ...
            <div class="flex flex-wrap xl:flex-nowrap gap-4 w-full rounded-2xl">
                <div class="flex flex-col gap-4 w-full xl:max-w-xl shrink-0">
                    <div class="flex flex-col gap-4 p-4 w-full rounded-2xl bg-bgSecondary bg-opacity-50 text-fgPrimary shadow-nr15" v-if="!loadingCurrentPlan">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <div class="flex items-center gap-2">
                                <img class="bg-fgPrimary p-2 rounded-xl w-16" :src="currentPlan.plan.icon" />
                    ...
                    <div class="flex flex-col gap-4 p-4 w-full rounded-2xl bg-bgSecondary bg-opacity-50 text-fgPrimary shadow-nr15" v-else>
                        <h3 class="flex items-center gap-4">
                            <b class="text-sm shrink-0">{{ $t("panel.billing.Current Plan Details") }}</b>
