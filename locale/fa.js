export default {
    ...
    faqs: {
        ...
        a3: "بله، شما در هر زمان میتوانید بازه پرداخت و نوع اشتراک خود را ارتقا یا کاهش بدهید و برای این کار فقط هزینه ماوتفاوت دو اشتراک را پرداخت خواهید کرد در نتیجه هزینه اضافی پرداخت نمیکنید",
