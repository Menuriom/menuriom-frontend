export default {
    ...
    meta: {
        indexTitle: "منوریوم - کیو ار منو ساز آنلاین و مدیریت سفارشات",
        indexDesc: "بهترین راه برای مدیریت رستوران شما. منوی دیجیتال بساز، لیست غذاهاتو مدیریت کن و آمار براساس نیاز های مشتریت دریافت کن",

        aboutTitle: "درباره منوریوم",
        aboutDesc: "ما به دنبال ساخت هر چیزی که شما برای رستوران خود نیاز دارید",

        faqsTitle: "سوالات متداول - منوریوم",
        faqsDesc: "سوالی درباره نحوه کار ما دارید؟",

        authTitle: "ورود و ثبت نام - منوریوم",
        authDesc: "شروع به ساخت منوی رستورانتون کنید، شروع به مدیریت رستوران خود کنید",

        contactUsTitle: "تماس با ما برای فروش یا درخواست قابلیت - منوریوم",
        contactUsDesc: "نیاز به کمک برای انتخاب پلن دارید، یا درمورد قابلیت ها سوال دارید، یا شاید چیزی میخواهید که ما نداریم. با تیم ما در تماس باشید",

        featuresTitle: "قابلیت های ما - منوریوم",
        featuresDesc: "قابلیت هایی که ما در منو، آمار و سیستم مدیریتی ارائه میدیم رو مشاهده کنید",
    ...
    faqs: {
        ...
        "Is there a free trail?": "آیا امکان تست رایگان وجود دارد؟",
        "Is there any fee other than the subscription fee?": "آیا لازم است غیر از هزینه اشتراک هزینه دیگری پرداخت شود؟",
        "Can I change my plan at anytime?": "آیا امکان تغییر اشتراک در هرزمان وجود دارد؟",
        "How can I build an account?": "چگونه حساب کاربری ایجاد کنم؟",
        "After I signed up how can I build a menu?": "بعد از ثبت نام چگونه منو بسازم؟",
        "Can I build multiple brands with a single account?": "آیا با یک ایمیل (حساب کاربری) می‌توان چند فروشگاه ایجاد کرد؟",
        "How can I add another user to help me manage my restaurant?": "چگونه شخص دیگری را برای مدیریت حساب اضافه کنم؟",
        "Can I change the restaurant username at any time?": "امکان تغییر نام کاربری رستوران هست؟",
        "How can I access the menu I created?": "چگونه به منوی ایجاد شده دسترسی پیدا کنم؟",
        "How can I change the looks of my restaurant menu?": "چگونه ظاهر منوی ساخته شده را تغییر دهم؟",
        "How can I change the content of my restaurant menu?": "از چه طریق میتوانم محتوای منو را اصلاح کنم؟",

        a1: "بله، اشتراک پایه کاملا رایگان و بدون محدودیت زمانی در نظر گرفته شده که امکان تست برای شما از این طریق فراهم است",
        a2: "خیر، شما غیر از هزینه اشتراک که پرداخت آن به صورت ماهانه و سالانه وجود دارد هزینه دیگری پرداخت نمیکنید",
        a3: "بله، شما در هر زمان میتوانید بازه پرداخت و نوع اشتراک خود را ارتقا یا کاهش بدهید و برای این کار فقط تفاوت هزینه دو اشتراک را پرداخت خواهید کرد در نتیجه هزینه اضافی پرداخت نمیکنید",
        a4: "از طریق نوار بالای سایت و بخش ورود و ثبتنام میتوانید با ایمیل خود یک حساب کاربری بسازید",
        a5: "بعد از ساخت حساب کاربری و ایجاد یک رستوران، منوی شما به صورت اتوماتیک ساخته میشود و فقط کافیست از قسمت ویرایش منو ایتم های منوی خود را اضافه کنید",
        a6: "درحال حاضر هر حساب کاربری فقط امکان ایجاد یک برند با چندین شعبه را دارد",
        a7: "هر عضو از خدمه شما نیاز به ثبت نام در سیستم را دارد. شما از طریق پنل مدیریت رستوران میتوانید درخواست دعوت به ایمیل که خدمه با آن ثبت نام کرده بفرستید. پس از تایید ایمیل توسط عضو خدمه، دسترسی رستوران شما برای وی امکان پذیر میشود",
        a8: "بله، درصورت آزاد بودن نام کاربری جدید امکان تغییر نام کاربری رستوران در هر زمان ممکن است. توجه کنید که با تغییر نام کاربری لینک منو و کد کیو ار شما تغییر میکند",
        a9: "منوی شما از طریق لینک ایجاد شده برای منو و اسکن کد کیو ار قابل دسترس است.",
        a10: "در پنل مدیریت رستوران، از قسمت ویرایش ظاهر منو شما میتوانید رنگ و ظاهر منوی خود را تغییر دهید",
        a11: "جزئیات مربوط به ایتم های منو از طریق قسمت ویرایش منو قابل تغییر است و همینطور اطلاعات مربوط به برند رستوران از بخش تنظیمات برند و اطلاعات هر شعبه از طریق بخش شعبه ها قابلیت ویرایش دارد",
    },
    ...
    panel: {
        ...
        Notifications: "اعلانیه ها",
        "No Notifications": "اعلانیه ای وجود ندارد",
        ...
        brands: {
            ...
            "By changing the brand username, menu link and QR code also will be changed!": "با تغییر یوزرنیم برند، لینک منو و کد QR نیز عوض میشود!",
        },
        ...
        "menu-style": {
            "Menu Style Editor": "ویرایش ظاهر منو",
            "Style your menu that suit your restaurant scheme": "منوی خود را مطابق با استایل رستوران خود طراحی کنید",
            "Main Menu Style": "صفحه اصلی منو",
